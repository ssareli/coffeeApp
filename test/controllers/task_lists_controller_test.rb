...
class TaskListsControllerTest < ActionController::TestCase
  ...
  test "should create task_list" do
    assert_difference('TaskList.count') do
      post :create, task_list: { name: @task_list.name, owner_id: @task_list.owner_id, project_id: @task_list.project_id, task_id: @task_list.task_id }
    end
  ...
  test "should update task_list" do
    patch :update, id: @task_list, task_list: { name: @task_list.name, owner_id: @task_list.owner_id, project_id: @task_list.project_id, task_id: @task_list.task_id }
    assert_redirected_to task_list_path(assigns(:task_list))
  end
